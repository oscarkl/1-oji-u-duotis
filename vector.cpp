...
void output(int o) {
    ...
    fr << "-----------------------------" << endl;
    for (std::vector<studentas>::iterator iter = rezult.begin(); iter != rezult.end(); ++iter) {
    ...
    if (o > 0) {
        ...
        fr << left << setw(16) << "Vardas" << left << setw(16) << "Pavarde" << left << setw(16) << "Galutinis(vid.)" << left << setw(16) << "Galutinis(med.)" << endl;
        fr << "-----------------------------" << endl;
        for (std::vector<studentas>::iterator it = nevyk.begin(); it != nevyk.end(); ++it) {
        ...
        fp << "-----------------------------" << endl;
        for (std::vector<studentas>::iterator ite = kietiakai.begin(); ite != kietiakai.end(); ++ite) {
